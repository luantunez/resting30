...
if banda==1
    ...
    direccion={'D:\EEG\resting48hs\fft\delta\Rho\s'};
    direccion2={'D:\EEG\resting48hs\fft\delta\RhoNorm\s'};
elseif banda==2
    FRANGE=[4:0.2:8];  %theta
    direccion={'D:\EEG\resting48hs\fft\theta\Rho\s'};
    direccion2={'D:\EEG\resting48hs\fft\theta\RhoNorm\s'};
elseif banda==3
    FRANGE=[8:0.2:12]; %alfa
    direccion={'D:\EEG\resting48hs\fft\alfa\Rho\s'};
    direccion2={'D:\EEG\resting48hs\fft\alfa\RhoNorm\s'};
elseif banda==4
     FRANGE=[12:1:35]; %beta
    direccion={'D:\EEG\resting48hs\fft\beta\Rho\s'};
    direccion2={'D:\EEG\resting48hs\fft\beta\RhoNorm\s'};
elseif banda==5
     FRANGE=[12:0.5:22]; %beta1
    direccion={'D:\EEG\resting48hs\fft\beta1\Rho\s'};
    direccion2={'D:\EEG\resting48hs\fft\beta1\RhoNorm\s'};
elseif banda==6
    FRANGE=[22:0.5:35]; %beta2
    direccion={'D:\EEG\resting48hs\fft\beta2\Rho\s'};
    direccion2={'D:\EEG\resting48hs\fft\beta2\RhoNorm\s'};
elseif banda==7
    FRANGE=[1:1:35]; %total
    direccion={'D:\EEG\resting48hs\fft\total\Rho\s'};
    direccion2={'D:\EEG\resting48hs\fft\total\RhoNorm\s'};
elseif banda==8
    FRANGE=[4:1:35]; %totalCut
    direccion={'D:\EEG\resting48hs\fft\totalCut\Rho\s'};
    direccion2={'D:\EEG\resting48hs\fft\totalCut\RhoNorm\s'};    
end
