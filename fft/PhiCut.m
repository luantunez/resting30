...
if banda==1
    ...
    direccion={'F:\pasantías Luchi\resting\fft\bandas\delta\RhoFase\s'};
    direccion2={'F:\pasantías Luchi\resting\fft\bandas\delta\PhiCut\s'};
elseif banda==2
    FRANGE=[4:0.2:8];  %theta
    direccion={'F:\pasantías Luchi\resting\fft\bandas\theta\RhoFase\s'};
    direccion2={'F:\pasantías Luchi\resting\fft\bandas\theta\PhiCut\s'};
elseif banda==3
    FRANGE=[8:0.2:12]; %alfa
    direccion={'F:\pasantías Luchi\resting\fft\bandas\alfa\RhoFase\s'};
    direccion2={'F:\pasantías Luchi\resting\fft\bandas\alfa\PhiCut\s'};
elseif banda==4
     FRANGE=[12:1:35]; %beta
    direccion={'F:\pasantías Luchi\resting\fft\bandas\beta\RhoFase\s'};
    direccion2={'F:\pasantías Luchi\resting\fft\bandas\beta\PhiCut\s'};
elseif banda==5
     FRANGE=[12:0.5:22]; %beta1
    direccion={'F:\pasantías Luchi\resting\fft\bandas\beta1\RhoFase\s'};
    direccion2={'F:\pasantías Luchi\resting\fft\bandas\beta1\PhiCut\s'};
elseif banda==6
    FRANGE=[22:0.5:35]; %beta2
    direccion={'F:\pasantías Luchi\resting\fft\bandas\beta2\RhoFase\s'};
    direccion2={'F:\pasantías Luchi\resting\fft\bandas\beta2\PhiCut\s'};
elseif banda==7
    FRANGE=[1:1:35]; %total
    direccion={'F:\pasantías Luchi\resting\fft\bandas\total\RhoFase\s'};
    direccion2={'F:\pasantías Luchi\resting\fft\bandas\total\PhiCut\s'};
elseif banda==8
    FRANGE=[4:1:35]; %totalCut
    direccion={'F:\pasantías Luchi\resting\fft\bandas\totalCut\RhoFase\s'};
    direccion2={'F:\pasantías Luchi\resting\fft\bandas\totalCut\PhiCut\s'};    
end
