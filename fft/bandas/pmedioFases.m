...
if banda==1
    ...
    direcc={'F:\pasantías Luchi\resting\fft\bandas\delta\PhiDesc\s'};
    direcc2={'F:\pasantías Luchi\resting\fft\bandas\delta\PhiCut\s'};
elseif banda==2
    %colorBar=[0 3]; %mismo colorbar que en 30 min
    colorBar=[0.8 2.2]; %nueva colorbar
    FRANGE=[4:0.2:8];  %theta
    direcc={'F:\pasantías Luchi\resting\fft\bandas\theta\PhiDesc\s'};
    direcc2={'F:\pasantías Luchi\resting\fft\bandas\theta\PhiCut\s'};
elseif banda==3
    %colorBar=[0 3]; %mismo colorbar que en 30 min
    colorBar=[0.8 2]; %nueva colorbar
    FRANGE=[8:0.2:12]; %alfa
    direcc={'F:\pasantías Luchi\resting\fft\bandas\alfa\PhiDesc\s'};
    direcc2={'F:\pasantías Luchi\resting\fft\bandas\alfa\PhiCut\s'};
elseif banda==4
    colorBar=[0 1.2];
     FRANGE=[12:1:35]; %beta
    direcc={'F:\pasantías Luchi\resting\fft\bandas\beta\PhiDesc\s'};
    direcc2={'F:\pasantías Luchi\resting\fft\bandas\beta\PhiCut\s'};
elseif banda==5
    %colorBar=[0 1.7]; %mismo colorbar que en 30 min
    colorBar=[0.2 1.5];  %nueva colorbar
     FRANGE=[12:0.5:22]; %beta1
    direcc={'F:\pasantías Luchi\resting\fft\bandas\beta1\PhiDesc\s'};
    direcc2={'F:\pasantías Luchi\resting\fft\bandas\beta1\PhiCut\s'};
elseif banda==6
    %colorBar=[0 0.6]; %mismo colorbar que en 30 min
    colorBar=[0.2 0.6]; %nueva colorbar
    FRANGE=[22:0.5:35]; %beta2
    direcc={'F:\pasantías Luchi\resting\fft\bandas\beta2\PhiDesc\s'};
    direcc2={'F:\pasantías Luchi\resting\fft\bandas\beta2\PhiCut\s'};
elseif banda==7
    colorBar=[0 3]; %mismo colorbar que en 30 min
    colorBar=[-1 2]; %nueva colorbar
    FRANGE=[1:1:35]; %total
    direcc={'F:\pasantías Luchi\resting\fft\bandas\total\PhiDesc\s'};
    direcc2={'F:\pasantías Luchi\resting\fft\bandas\total\PhiCut\s'};
elseif banda==8
    colorBar=[-0.2 2.2];
    FRANGE=[4:1:35]; %totalCut
    direcc={'F:\pasantías Luchi\resting\fft\bandas\totalCut\PhiDesc\s'};
    direcc2={'F:\pasantías Luchi\resting\fft\bandas\totalCut\PhiCut\s'};
end
