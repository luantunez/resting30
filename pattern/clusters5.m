...
restNom=pmedioClustBuenosNom-pmedioClustMalosNom;   %nombres

restDef=pmedioClustBuenosDef-pmedioClustMalosDef;   %definiciones
...
%% veo cuantas restas random son menores en valor absoluto a la resta de medias de datos compartimentales
...
for i=1:10000
    if(restPmedio(i)<restNom)
        contNom=contNom+1;
    end
    
    if(restPmedio(i)<restDef)
        contDef=contDef+1;
    end
end

contNomRelMenor=contNom/10000;   %lo relativizo
contNomDefMenor=contDef/10000;   %lo relativizo
...
contNomRelMayor=contNom/10000;   %lo relativizo
contNomDefMayor=contDef/10000;   %lo relativizo