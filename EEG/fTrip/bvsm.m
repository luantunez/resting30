...
nclust=3 %que cluster de los neg 1 y 2 pos 3
...
elseif banda==6
    ...
    colorBar=[0 0.4];  %cluster 1
    %colorBar2=[-0.5 0.3];  %cluster 1 resta
    %colorBar=[0 0.2];  %cluster 2
    %colorBar2=[-0.05 0.05];  %cluster 2 resta
    colorBar2=[-0.05 0.02];
elseif banda==7
...
for i=1:34      %30 min
     if i~=[18 28 30 4 16 32] 
         ...
         elseif find(i==malosNom30)~=0 
            ...
            sujF30pCut=(sujF30(i).suj.sujFinE.freq.powspctrm(:,20:35,:)); %con esto selecciono las frecuencias a evaluar, corresponden al cluster beta2
...
for i=1:23      %48 hs
     if i~=3 && i ~= 14 && i ~= 16 && i ~= 18  && i ~= 15 && i~=17  
         ...
         elseif find(i==malosNom48)~=0 
            ...
            sujF48pCut=(sujF48(i).suj.sujFinE.freq.powspctrm(:,20:35,:)); %con esto selecciono las frecuencias a evaluar, corresponden al cluster beta2
